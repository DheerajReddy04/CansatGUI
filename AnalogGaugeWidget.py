...
try:
    ...
    from PyQt5.QtGui import QPolygon, QPolygonF, QColor, QPen, QFont, QPainter, QFontMetrics, QConicalGradient, QRadialGradient, QFontDatabase, QBrush

    from PyQt5.QtCore import Qt, QTime, QTimer, QPoint, QPointF, QRect, QRectF, QSize, QObject, pyqtSignal
...
class AnalogGaugeWidget(QWidget):
    ...
    def update_values(self, temperature, humidity, airquality):
        # Update the dials with the new values
        self.gauge_temperature.setValue(temperature)
        self.gauge_humidity.setValue(humidity)
        self.gauge_airquality.setValue(airquality)

    def setValue(self, value):
        self.value = value
        self.update()  # Trigger a repaint of the widget                                    #REMOVE IF NEEDEDDDDDD

    def paintEvent(self, event):
        # Your custom painting code here to display the gauge with the current value
        pass
